            ...
            uploadServiceGetResolve(upload)
                .then(() =>
                {
                    ...
                    let expectedValues: { name: string, suggested?: number, hasEffectiveLevel?: boolean }[] =
                        [
                            { name: "Argaiv", suggested: 5.3202157920402164e+39 },
                            { name: "Atman", suggested: 254, hasEffectiveLevel: true },
                            { name: "Berserker" },
                            { name: "Bhaal", suggested: 5.3202157920402164e+39, hasEffectiveLevel: true },
                            { name: "Bubos", suggested: 250 },
                            { name: "Chawedo" },
                            { name: "Chronos", suggested: 245 },
                            { name: "Dogcog", suggested: 256 },
                            { name: "Dora", suggested: 255 },
                            { name: "Energon" },
                            { name: "Fortuna", suggested: 254, hasEffectiveLevel: true },
                            { name: "Fragsworth", suggested: 5.3202157920402164e+39, hasEffectiveLevel: true },
                            { name: "Hecatoncheir" },
                            { name: "Juggernaut", suggested: 6.0359189349445655e+31 },
                            { name: "Kleptos" },
                            { name: "Kumawakamaru", suggested: 256, hasEffectiveLevel: true },
                            { name: "Libertas", suggested: 4.9265198234292406e+39 },
                            { name: "Mammon", suggested: 4.9265198234292406e+39 },
                            { name: "Mimzee", suggested: 4.9265198234292406e+39 },
                            { name: "Morgulis", suggested: 2.8304696073874106e+79 },
                            { name: "Nogardnit", suggested: 5.675866705176987e+31 },
                            { name: "Revolc" },
                            { name: "Siyalatas", suggested: 5.3202157920402164e+39 },
                            { name: "Sniperino", hasEffectiveLevel: true },
                            { name: "Solomon", suggested: 1.1898352785663172e+32, hasEffectiveLevel: true },
                            { name: "Vaagur" },
                        ];
        ...
        it("should display data based on hybrid playstyle and Available Souls without using souls from ascension", async(() =>
        {
            ...
            uploadServiceGetResolve(upload)
                .then(() =>
                {
                    ...
                    let expectedValues: { name: string, suggested?: number, hasEffectiveLevel?: boolean }[] =
                        [
                            { name: "Argaiv", suggested: 2.2854864672361672e+39 },
                            { name: "Atman", suggested: 252, hasEffectiveLevel: true },
                            { name: "Berserker" },
                            { name: "Bhaal", suggested: 2.2854864672361672e+39, hasEffectiveLevel: true },
                            ...
                            { name: "Fragsworth", suggested: 2.2854864672361672e+39, hasEffectiveLevel: true },
                            { name: "Hecatoncheir" },
                            { name: "Juggernaut", suggested: 3.0703149217266657e+31 },
                            { name: "Kleptos" },
                            { name: "Kumawakamaru", suggested: 253, hasEffectiveLevel: true },
                            { name: "Libertas", suggested: 2.116360468660691e+39 },
                            { name: "Mammon", suggested: 2.116360468660691e+39 },
                            { name: "Mimzee", suggested: 2.116360468660691e+39 },
                            { name: "Morgulis", suggested: 5.223448391919656e+78 },
                            { name: "Nogardnit", suggested: 2.8871657201599775e+31 },
                            { name: "Revolc" },
                            { name: "Siyalatas", suggested: 2.2854864672361672e+39 },
                            { name: "Sniperino", hasEffectiveLevel: true },
                            { name: "Solomon", suggested: 6.052382494783322e+31, hasEffectiveLevel: true },
                            { name: "Vaagur" },
                        ];
        ...
        it("should display data based on idle playstyle and Available Souls without using souls from ascension", async(() =>
        {
            ...
            uploadServiceGetResolve(upload)
                .then(() =>
                {
                    ...
                    let expectedValues: { name: string, suggested?: number, hasEffectiveLevel?: boolean }[] =
                        [
                            { name: "Argaiv", suggested: 2.2856995934012445e+39 },
                            { name: "Atman", suggested: 252, hasEffectiveLevel: true },
                            { name: "Berserker" },
                            ...
                            { name: "Kleptos" },
                            { name: "Kumawakamaru", suggested: 253, hasEffectiveLevel: true },
                            { name: "Libertas", suggested: 2.1165578234895524e+39 },
                            { name: "Mammon", suggested: 2.1165578234895524e+39 },
                            { name: "Mimzee", suggested: 2.1165578234895524e+39 },
                            { name: "Morgulis", suggested: 5.224422631274614e+78 },
                            { name: "Nogardnit", suggested: 2.8873811053145465e+31 },
                            { name: "Revolc" },
                            { name: "Siyalatas", suggested: 2.2856995934012445e+39 },
                            { name: "Sniperino", hasEffectiveLevel: true },
                            { name: "Solomon", suggested: 6.052834007950733e+31, hasEffectiveLevel: true },
                            { name: "Vaagur" },
                        ];
        ...
        it("should display data based on active playstyle and Available Souls without using souls from ascension", async(() =>
        {
            ...
            uploadServiceGetResolve(upload)
                .then(() =>
                {
                    ...
                    let expectedValues: { name: string, suggested?: number, hasEffectiveLevel?: boolean }[] =
                        [
                            { name: "Argaiv", suggested: 2.2856759263102303e+39 },
                            { name: "Atman", suggested: 252, hasEffectiveLevel: true },
                            { name: "Berserker" },
                            { name: "Bhaal", suggested: 2.2856759263102303e+39, hasEffectiveLevel: true },
                            { name: "Bubos", suggested: 248 },
                            { name: "Chawedo" },
                            { name: "Chronos", suggested: 244 },
                            { name: "Dogcog", suggested: 254 },
                            ...
                            { name: "Energon" },
                            { name: "Fortuna", suggested: 252, hasEffectiveLevel: true },
                            { name: "Fragsworth", suggested: 2.2856759263102303e+39, hasEffectiveLevel: true },
                            { name: "Hecatoncheir" },
                            { name: "Juggernaut", suggested: 3.0705185349909972e+31 },
                            { name: "Kleptos" },
                            { name: "Kumawakamaru", suggested: 253, hasEffectiveLevel: true },
                            { name: "Libertas" },
                            { name: "Mammon", suggested: 2.1165359077632734e+39 },
                            { name: "Mimzee", suggested: 2.1165359077632734e+39 },
                            { name: "Morgulis", suggested: 5.22431444011413e+78 },
                            { name: "Nogardnit" },
                            { name: "Revolc" },
                            { name: "Siyalatas" },
                            { name: "Sniperino", hasEffectiveLevel: true },
                            { name: "Solomon", suggested: 6.052783869035854e+31, hasEffectiveLevel: true },
                            { name: "Vaagur" },
                        ];
